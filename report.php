...
<div class="col-8"><label><?=render_lang('Recent Photo','हालसालैको फोटो')?><input type="file" name="photo" accept="image/jpeg,image/png,image/webp,image/*" data-preview="photoPreview"><span class="hint"><?=render_lang('Recommended: clear recent face photo. Max 8MB.','सिफारिस: हालसालैको स्पष्ट अनुहार देखिने फोटो। अधिकतम 8MB।')?></span></label><img id="photoPreview" class="photo-preview" alt="Preview"></div>
...
<div class="col-6"><label><?=render_lang('Photo Upload (Optional)','फोटो अपलोड (ऐच्छिक)')?><input type="file" name="photo" accept="image/jpeg,image/png,image/webp,image/*" data-preview="photoPreview"><span class="hint"><?=render_lang('Optional. Take a safe photo only if possible. Max 8MB.','ऐच्छिक। सुरक्षित भए मात्र फोटो खिच्नुहोस्। अधिकतम 8MB।')?></span></label><img id="photoPreview" class="photo-preview" alt="Preview"></div>
